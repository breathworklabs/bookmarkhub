  ...
  transformToBookmarkFormat(twitterData) {
    return {
      ...
      metadata: {
        ...
        tweet_created_at: twitterData.created_at || twitterData.createdAt, // Store original tweet date
      },
      created_at: this.parseTwitterDate(twitterData.created_at || twitterData.createdAt),
