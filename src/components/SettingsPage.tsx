...
import { useSettingsStore, type ExtensionSettings, type DisplaySettings } from '@/store/settingsStore'
                          ...
                          <VStack alignItems="stretch" gap={4}>
                            ...
                            <VStack alignItems="stretch" gap={2}>
                              ...
                              <SelectRoot
                                ...
                                onValueChange={(details) =>
                                  setAutoSyncInterval(details.value[0] as ExtensionSettings['autoSyncInterval'])
                                }
                                size="sm"
                              >
                                <SelectTrigger
                            ...
                            <VStack alignItems="stretch" gap={2}>
                              ...
                              <SelectRoot
                                ...
                                onValueChange={(details) =>
                                  setImportDuplicates(details.value[0] as ExtensionSettings['importDuplicates'])
                                }
                                size="sm"
                              >
                                <SelectTrigger
                        ...
                        >
                          <VStack alignItems="stretch" gap={2}>
                            ...
                            <SelectRoot
                              ...
                              onValueChange={(details) =>
                                setTheme(details.value[0] as DisplaySettings['theme'])
                              }
                              size="sm"
                            >
                              <SelectTrigger
                            ...
                            <VStack alignItems="stretch" gap={2}>
                              ...
                              <SelectRoot
                                ...
                                onValueChange={(details) =>
                                  setSortBy(details.value[0] as DisplaySettings['sortBy'])
                                }
                                size="sm"
                              >
                                <SelectTrigger
