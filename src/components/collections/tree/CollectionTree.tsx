...
export const CollectionTree = memo<CollectionTreeProps>(
  ({
    ...
    const toggleSectionCollapse = useCollectionsStore(
      (state) => state.toggleSectionCollapse
    )
    const isSectionCollapsed = useCollectionsStore(
      (state) => state.isSectionCollapsed
    )
