            ...
            >
              ...
              <VStack alignItems="stretch" p={6} gap={6}>
                ...
                <VStack alignItems="stretch" gap={3}>
                  ...
                  >
                    You can accept or reject this notice. Rejecting does not
                    limit app functionality since we do not use tracking
                    cookies. Your choice is stored locally and can be changed
                    anytime by clearing the browser storage or returning to this
                    page.
                  </Text>
                </VStack>
