...
import { LuArrowLeft, LuFileText, LuShield, LuUsers, LuInfo } from 'react-icons/lu'
        ...
        <Flex flex={1} direction="column" w="100%" overflowY="auto" p={8} style={{ background: 'var(--color-bg-primary)' }}>
          ...
          >
            ...
            <HStack p={6} borderBottomWidth="1px" style={{ borderColor: 'var(--color-border)' }}>
              <LuFileText size={20} style={{ color: 'var(--color-text-primary)' }} />
            ...
            <VStack alignItems="stretch" p={6} gap={6}>
              ...
              <VStack alignItems="stretch" gap={4}>
                ...
                <Text fontSize="sm" style={{ color: 'var(--color-text-secondary)', lineHeight: '1.6' }}>
                  These Terms of Service ("Terms") govern your use of X Bookmark Manager, a privacy-focused
                  bookmark management application. By using our service, you agree to be bound by these Terms.
                </Text>
              </VStack>
              ...
              <VStack alignItems="stretch" gap={3}>
                ...
                <Text fontSize="sm" style={{ color: 'var(--color-text-secondary)', lineHeight: '1.6' }}>
                  X Bookmark Manager is designed with privacy as a core principle. All your data is stored
                  locally on your device and is never transmitted to our servers. We do not collect, store,
                  or process your personal information or bookmark data.
                </Text>
              </VStack>
              ...
              <VStack alignItems="stretch" gap={3}>
                ...
                <Text fontSize="sm" style={{ color: 'var(--color-text-secondary)', lineHeight: '1.6' }}>
                  Your bookmarks, collections, and settings are stored exclusively in your browser's local
                  storage. This means:
                </Text>
              ...
              <VStack alignItems="stretch" gap={3}>
                ...
                <Text fontSize="sm" style={{ color: 'var(--color-text-secondary)', lineHeight: '1.6' }}>
                  Our Chrome extension allows you to import bookmarks from X/Twitter. The extension:
                </Text>
                <VStack alignItems="stretch" gap={2} pl={4}>
                  <Text fontSize="sm" style={{ color: 'var(--color-text-secondary)', lineHeight: '1.6' }}>
                    • Only accesses your X/Twitter bookmarks when you explicitly request it
                  </Text>
                  <Text fontSize="sm" style={{ color: 'var(--color-text-secondary)', lineHeight: '1.6' }}>
                  ...
                  <Text fontSize="sm" style={{ color: 'var(--color-text-secondary)', lineHeight: '1.6' }}>
                    • Requires your explicit permission for each import operation
                  </Text>
                </VStack>
              </VStack>
              ...
              <VStack alignItems="stretch" gap={3}>
                ...
                <Text fontSize="sm" style={{ color: 'var(--color-text-secondary)', lineHeight: '1.6' }}>
                  X Bookmark Manager is provided "as is" without warranties of any kind. We disclaim all
              ...
              <VStack alignItems="stretch" gap={3}>
                ...
                <Text fontSize="sm" style={{ color: 'var(--color-text-secondary)', lineHeight: '1.6' }}>
                  To the maximum extent permitted by law, X Bookmark Manager and its developers shall not
                  be liable for any indirect, incidental, special, consequential, or punitive damages,
                  including but not limited to loss of profits, data, or use, arising out of or relating
              ...
              <VStack alignItems="stretch" gap={3}>
                ...
                <Text fontSize="sm" style={{ color: 'var(--color-text-secondary)', lineHeight: '1.6' }}>
                  Since your data is stored locally, you are responsible for backing up your bookmarks.
                  We recommend using the export functionality regularly to create backups of your data.
                  We are not responsible for data loss due to browser issues, device problems, or user error.
                </Text>
              </VStack>
