...
export const mockBookmarks: Bookmark[] = [
  {
    ...
    description:
      'The future of transportation is electric. Tesla is leading the charge with sustainable energy solutions that will transform how we move.',
    content:
      'The future of transportation is electric. Tesla is leading the charge with sustainable energy solutions that will transform how we move. 🚗⚡',
    author: 'Elon Musk',
    domain: 'x.com',
  ...
  },
  {
    ...
    description:
      'Introducing GPT-4 Turbo with 128K context length. This represents a significant leap forward in AI capabilities.',
    content:
      'Introducing GPT-4 Turbo with 128K context length. This represents a significant leap forward in AI capabilities, enabling more comprehensive understanding of large documents and complex conversations.',
    author: 'OpenAI',
    domain: 'x.com',
    source_platform: 'twitter',
  ...
  },
  {
    ...
    description:
      'Next.js 14 is here with Turbo Mode performance improvements and Server Actions.',
    content:
