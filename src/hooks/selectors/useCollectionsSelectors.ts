...
export const useCollectionsSelectors = () => {
  return {
    ...
    // UI State
    isCreatingCollection: useCollectionsStore(state => state.isCreatingCollection),
    collectionFilter: useCollectionsStore(state => state.collectionFilter),
    expandedCollections: useCollectionsStore(state => state.expandedCollections),
    ...
    addBookmarkToCollection: useCollectionsStore(state => state.addBookmarkToCollection),
    removeBookmarkFromCollection: useCollectionsStore(state => state.removeBookmarkFromCollection),
    getBookmarksByCollection: useCollectionsStore(state => state.getBookmarksByCollection),
    moveMultipleBookmarks: useCollectionsStore(state => state.moveMultipleBookmarks),

    // Actions - UI
    setCreatingCollection: useCollectionsStore(state => state.setCreatingCollection),
    setCollectionFilter: useCollectionsStore(state => state.setCollectionFilter),
    toggleCollectionExpansion: useCollectionsStore(state => state.toggleCollectionExpansion),
